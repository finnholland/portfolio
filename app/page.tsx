      ...
      <a key={project.title} href={project.githubUrl} target='_blank'
        ...
        <div className='mr-5 shrink-0'>
          <div className=' w-20 h-14 relative block'>
            <Image className='group-hover/project:border-custom-blue-100 group-hover/project:border-2 rounded-md object-contain' src={project.imageUrl} fill objectFit='cover' alt={project.title}/>
          </div>
        </div>
